...
export default function AdminAccount() {
  ...
  async function submit(e) {
    ...
    if (messages.length == 0) {
      ...
      try {
        await axios
          .post(`${process.env.REACT_APP_SERVER_URL}/adminUpdate`, {
            formData,
            messages,
          })
          .then((res) => {
        ...
        <section className="text-gray-600  mt-6 body-font grid place-items-center  relative  ">
          <div className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col   mt-10 md:mt-0 relative z-10 shadow-md">
            ...
            <div className="relative mb-4">
              ...
              >
                <option value="Neck-sets">Neck-sets</option>
                <option value="Earrings">Earrings</option>
                <option value="Bangles-Bracelets">Bangles-Bracelets</option>
                <option value="Mangtika/Tikka set">Mangtika/Tikka set</option>
            ...
            <div className="relative mb-4">
              <label for="stocks" className="leading-7 text-sm text-gray-600">
                Number of stocks
              </label>
              <input
